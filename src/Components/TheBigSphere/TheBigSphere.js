...
class TheBigSphere extends React.Component {
componentDidMount() {
console.log("mounted")
//  const gui = new dat.GUI()
  //Loading 
  const textureLoader = new THREE.TextureLoader()
  const normalTexture = textureLoader.load('https://i.ibb.co/xY5gvtT/Normal-Map.png')
...
pointLight2.intensity = 10
  ...
  // when making a Mesh such as the standard material
    ...
    var fogColor = new THREE.Color(0x151516);
    scene.background = fogColor; // Setting fogColor as the background color also
    scene.fog = new THREE.Fog(fogColor, 0.2, 2);
